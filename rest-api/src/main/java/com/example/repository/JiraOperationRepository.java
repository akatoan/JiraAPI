...
public class JiraOperationRepository {
		...
		Map<String, Object> jsonMap = new LinkedHashMap<>();
			...
			Map<String, Object> fields = new LinkedHashMap<>();
				...
				Map<String, Object> assignee = new LinkedHashMap<>();
					assignee.put("name", issueInfo.getAssignee());
	...
	public IssueInfo getIssueInfoAPI(IssueInfo issueInfo) throws IOException {
		...
		String assignee = root.get("issues").get(0).get("fields").get("assignee").get("name").toString();
		...
		assignee = assignee.substring(1, length-1);

		// Update summary
		issueInfo.setSummary(issueInfo.getSummary() + " " + summary);
		issueInfo.setAssignee(assignee);
